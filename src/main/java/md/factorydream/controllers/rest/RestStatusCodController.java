...
public class RestStatusCodController {
    ...
    public ResponseEntity<List<StatusCodeRest>> getAllValueDiameters(@RequestParam short statusGroup) {

        List<StatusCodeRest> statusCodeValueRestList = (ArrayList<StatusCodeRest>) statusCodService.findStatusCodByGroupId(statusGroup);
