 ...
 */
public class CustomersUpdateRest {
    ...
    public CustomersUpdateRest(long customersId, short statusCodeId, String name, String address, String phone, String email, String customerDescription, String note) {
